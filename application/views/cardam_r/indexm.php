...
{ 
	...
	.btn{
		...
		<script src="https://js.issuepoll.net/card/am/common_v14.js?version=9" type="text/javascript"></script>
		<script src="https://js.issuepoll.net/card/am/swiper.min.js"></script>
		
		<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-157922949-1"></script>
<script>
	...
	<body style="background-color: #eceff1">
		<div id="wrap" style="max-width: 650px;margin: 0 auto;">
			<div class="top bg">
				<header>
					<div class="layout">
						<a class="logo" href="./?whence=<?=$whence?>"></a>
					</div>
				</header>
				<div class="bigmenu">
<!--					
...
-->
					...
					<div class="fm_body">
					<div class="top">
						<h1 class="h1_tit"><b>소중한 내차</b>, 비싸게 팔고 싶다면</h1>
						<h2 class="h2_tit">다이렉트 내차판매</h2>
						<p style="background-image: url('https://img.issuepoll.net/card/am/Mercedes-Benz_cls.png');height: 130px;background-repeat: no-repeat;background-size: 380px auto;background-position: center center;width: 100%;margin-bottom: -3px"></p>
					</div>
					<div class="fm_card">
						<form action="/json_cardam" method="post" target="_parent">
							<input type="hidden" name="type" value="s">
							<input type="hidden" name="whence" value="<?=$whence?>">
							<input type="hidden" name="day" value="3d">
...
<!--   차량번호 -> 차량정보로 수정
									...
									<p>
										<span>
											<input class="inp_txt" type="text" id="carInfo" name="carno" placeholder="예시) 12가1234" maxlength="40" required=""/>
										</span>
									</p>
-->
									<p class="lb">보유차랑정보</p>
									<p>
										<span>
											<input class="inp_txt" type="text" id="carInfo" name="carInfo" placeholder="예시) 12년식 아반떼MD" maxlength="40" required=""/>
										</span>
									</p>
								</div>
...
<!-- 									<li>- 보다 정확한 차량시세 및 견적을 도와드리기 위해 상담원이 전화드릴 수 있습니다.</li> -->
							...
							<div class="apply_box">
								<button type="submit" class="btn apply">내 차 판매 신청하기</button>
							</div>
						</form>
					</div>
				</div>
...
-->
				...
				<script>					
					getJSON("//"+window.location.hostname+'/get_rv/0/5', review_list);	
...
-->
				...
				<script>					
					getJSON("//"+window.location.hostname+'/get_cs/0/6', cs_list);	
...
<!-- 					<script src="https://js.issuepoll.net/card/am/swiper.min.js"></script> -->
				...
				<div class="section cs">
					...
					<div class="cs_box">	
						<ul>
							<li>
								<a class="cs_call call bg_grid" href="tel:1566-7620">
									<span class="tit">고객상담센터</span>
									<span class="tel">1566-7620</span>
									<span class="ico_call"></span>								
								</a>
							</li>
							<li>
								<a class="cs_call fax" href="sms:010-9350-1225;?&body=내차팔기 상담 부탁드립니다.">
									<span class="tit">문자상담접수(상시가능)</span>
									<span class="tel">010-9350-1225</span>
...
<!--
					<div class="ft_customer">
						<p>
							<a href="tel:032-297-8500">고객센터 1566-7620</a>
						</p>
						<p>
							<a href="tel:032-297-8500">사업제휴센터 1566-7620</a>
						</p>
					</div>
-->
					<div class="ft_info">
					<p>인천광역시 서구 봉수대로 158 B1층</p>
<!-- 						<p>경기도 시흥시 산기대로 237 12층</p> -->
