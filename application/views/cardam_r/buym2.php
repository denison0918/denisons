...
<script type="text/javascript">
	if( (document.referrer).match(/KC/)){
      kakaoPixel('1924823491651584035').pageView('buy');
    }
</script>
	</head>
	<body onload="init()">
		<div id="wrap">
			<div class="top bg">
				...
				<div class="fm_body">
					<div class="top">
						<h1 class="h1_tit">다이렉트 내차구매</h1>
						<h2 class="h2_tit">지역·구매정보입력 및 상담신청</h2>
					</div>
					<div class="fm_card">
						<form action="/json_cardam" method="post" target="_blank">
							...
							<div class="card_tit">지역 및 구매정보입력</div>
							<div class="info_items">
								...
								<div class="item">
									...
									<p>
										<span>
											<input class="inp_txt" type="text" name="carInfo" placeholder="예시) 아반떼AD 17년식" maxlength="40" required=""/>
										</span>
									</p>
								</div>
								
								<div class="item">
									<p class="lb">타사에서 알아보신 차량이 있으신가요?</p>
									<p class="radio_box">
										<span class="itm" for="accident_false">
											<input type="radio" name="accident" value="0" id="accident_false"  />
											<span class="txt">있음</span>
										</span>
										<span class="itm" for="accident_true">
											<input type="radio" name="accident" value="1" id="accident_true" checked=""/>
...
-->
										...
										<span class="pr">
											<input class="inp_txt" type="tel" name="phone" placeholder="'-' 없이 입력" maxlength="40" minlength="11" required=""/>
										</span>
									</p>
								</div>
							</div>
							...
							<div class="apply_box">
								<button type="submit" class="btn apply">추천 및 상담신청</button>
							</div>
						</form>
					</div>
				</div>
