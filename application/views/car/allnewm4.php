...
*/
			...
			document.getElementById('location').value = (results[8].formatted_address.slice(5)).split(" ")[0];
...
/* 				background-color: #3E9ACC; */
			...
			.APPCARDBBOX .CARDBHD{display: inline-block;width: 25%;vertical-align: top;padding:15px; height: 45px;}
			.APPCARDBBOX .CARDBHD SPAN{font-size: 11pt;line-height: 15px;}
			.APPCARDBBOX .CARDBBD{display: inline-block;width: 75%;vertical-align: top;padding: 8px;height: 45px;}
			.APPCARDBBOX .CARDBBD INPUT{width: 100%;border: none;border-radius: 0;background-color: transparent;font-size: 11pt;line-height: 25px;}
					...
					<div style="padding-top: 60px;">
						...
						<div class="app-body">
							<div>
								<div>
									<div style="padding: 4%;" >
										<div class="APPCARICON">
											<span style="background-image: url('https://img.cardam.co.kr/Content/logo_big_trans64x40.png');background-size: 18px 18px;background-position: center center;background-repeat: no-repeat;display: block ;height: 100%;width: 100%; display: none"></span>
										</div>
										<div class="APPCARDBBOX">
											<div class="LAYOUT">
												<div style="border-bottom:1px solid #e5e5e5;">
													<h3>차량정보를 입력해주세요.</h3>
												</div>
												<div style="border-bottom:1px solid #e5e5e5;">
													<div class="CARDBHD" style="background-color: #F6F7F9;">
														<span style="color: #b2b1b6;">판매지역</span>
													</div>
													<div class="CARDBBD" style="background-color: #F6F7F9;">
														<input type="text" id="location" style="color: #b2b1b6">
													</div>
												</div>
												<div style="border-bottom:1px solid #e5e5e5 ">
													<div class="CARDBHD">
