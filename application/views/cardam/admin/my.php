...
-webkit-align-items: center;
	...
	.buyer-d ul li input[type="password"], .seller-d ul li input[type="password"]{
		width: 150px;
		height: auto;
...
<!--
		<div class="container-right">
			...
			<div class="pay-title">
			<h1>내정보</h1><p>회원정보를 확인하고 관리하실 수 있습니다.</p>
			</div>
			<div class="pay-container">
				
				<div class="buyer">
					<div class="buyer-con">
						<div class="buyer-h"><h2>회원정보</h2></div>
						<div class="buyer-d">
							<ul>
								<li>회원명 : <?php echo $name ?></li>
								<li>아이디 : <?php echo $user_data?></li>
								<li>비밀번호 : <input type="password"></li>
								<li>비밀번호확인 : <input type="password"></li>
								<li>이메일 : <?php echo $mail?></li>							
								<li>소속 : <?php echo $og?></li>
								<li>사원번호 : <?php echo $em?></li>
								<li>가입일시 : <?php echo $reg?></li>
								<li><input type="button" value="정보수정"></li>
							</ul>
						</div>
					</div>
				</div>
