...
/* 		border:1px solid rgba(0,0,0,0.15); */
	...
	.controller('registerCtrl',['$http', '$scope', function(funeralList, $http, $scope){
	...
	<?php 	$attributes = array( 'id' => 'myform' ,'name'=> 'myform' , 'accept-charset'=>'utf-8');
		echo form_open_multipart('http://www.gieok.xyz/index.php/admin/register/create',$attributes);
	?>
					<div class="img">
