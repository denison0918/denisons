<html>
	...
	*{margin: 0;padding: 0;box-sizing: border-box;-webkit-text-size-adjust: 100%;-webkit-overflow-scrolling: auto;-webkit-font-smoothing: antialiased;outline:none;-webkit-overflow-scrolling: touch;}
	...
	.numline label.checkNum{color: #fff;background-color: #4d4d4d}
  ...
  gtag('config', 'UA-157922949-2');
	...
	//		let groupA = array();
			...
			function clearPaper(){
			 ...
			 function insertNum(target){
				...
				const idx = paper.indexOf(target.value);
			...
			function checkPrice(){
				...
				if((paper.length == 6) || (paper.indexOf('46') > -1)){
					...
					document.getElementById('gameCnt').innerHTML = Object.keys(lotto).length ? Object.keys(lotto).length + ",000" : 0;
	...
	<body onload="init()">
		...
		<div class="container">
				...
				<div class="paper">
					...
					<div class="checkNumGroup">
						...
						<div class="etcLine">
							...
							<span></span>
							<span class="last">
							<input type="checkbox" id="check645num46" name="check645num" value="46" onchange="insertNum(this)" />
				...
				<div class="bottom">
					<form action="/order_lotto" method="post" onsubmit="return submitCheck()">
